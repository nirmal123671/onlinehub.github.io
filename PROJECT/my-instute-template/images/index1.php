...
<div class="careeersss">                                 
	<div class="container">
		<h1> Career Pointer </h1>    
		
<div class="row">

  <div class="col-sm-6 col-md-4"> 
    <div class="thumbnail">
      <img src="images/career.jpg" class="" alt="..."> 
       <h2>Career</h2>
		<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
		<div class="btnnntingf">
			<a href=""> Read More </a>     
		</div>
    </div>
  </div>
   ...
   <div class="col-sm-6 col-md-4"> 
    <div class="thumbnail">
      <img src="images/iStock_000053140402_Small-intern-350x260.jpg" class="" alt="..."> 
       <h2>Career</h2>
       <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
	   <div class="btnnntingf">
			<a href=""> Read More </a>     
   ...
   <div class="col-sm-6 col-md-4"> 
    <div class="thumbnail">
      <img src="images/2_secretary.jpg" class="" alt="..."> 
       <h2>Career</h2>
		<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
		<div class="btnnntingf">
			<a href=""> Read More </a>     
